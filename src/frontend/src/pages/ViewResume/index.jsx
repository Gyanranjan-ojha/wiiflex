...
import ViewResumeColumn from "../../components/ViewResumeColumn";
import ViewResumeStackjobtitle from "../../components/ViewResumeStackjobtitle";
...
export default function ViewResume() {
  ...
  console.log("ViewResumePage id:", jobId);
  ...
  return (
    <ErrorBoundary>
      ...
      <Navbar id={jobId} />
      <div className="flex w-full flex-col items-center gap-[57px] bg-white-A700 pb-[26px] sm:gap-7 sm:py-5">
        <div className="mx-auto flex w-full max-w-[980px] flex-col items-start gap-[37px] md:p-5">
          ...
          <div className="flex items-start self-stretch md:flex-col">
            <div className="flex w-[17%] flex-col items-start md:w-full">
              ...
              <div className="mt-5 flex flex-col items-start gap-[11px]">
                ...
                <div className="flex flex-wrap gap-[11px]">
                  ...
                  <Heading as="h5" className="self-end"></Heading>
                </div>
              </div>
            ...
            <div className="ml-[27px] h-[1094px] w-px md:ml-0 md:h-px md:w-[1094px]" />
            <div className="flex w-[57%] flex-col md:ml-0 md:w-full">
              <div className="flex w-[91%] flex-col items-start gap-2 md:w-full">
                ...
                <Text as="p" className="w-full leading-6 !text-gray-800_02">
                  <>
                    Been working as a lead consultancy in RealEstate for last 5
                    years. Lorem Ipsum is simply dummy text of the printing and
            ...
            <div className="ml-[30px] flex w-[27%] flex-col items-start md:ml-0 md:w-full">
              ...
              <Heading
                size="xl"
                as="h6"
                className="mt-[22px] !text-light_blue-700"
              >
                Certifications
              </Heading>
              ...
              <Heading
                size="xl"
                as="h6"
                className="mt-[15px] !text-light_blue-700"
              >
                Software
              </Heading>
              <div className="mt-3.5 flex gap-[18px]">
                <Button
                  color="teal_900"
                  className="min-w-[102px] rounded-[17px]"
                >
                  Adobe XD
                </Button>
                <Button
                  color="teal_900"
                  className="min-w-[111px] rounded-[17px]"
                >
                  Sketch Pro
                </Button>
              </div>
              <Heading
                size="xl"
                as="h6"
                className="mt-[17px] !text-light_blue-700"
              >
                language
              </Heading>
              <div className="mt-[11px] flex gap-[18px]">
                <Button
                  color="teal_900"
                  className="min-w-[102px] rounded-[17px] sm:px-5"
                >
                  English
                </Button>
                <Button
                  color="teal_900"
                  className="min-w-[111px] rounded-[17px] sm:px-5"
                >
                  French
                </Button>
              </div>
              ...
              <div className="mt-[13px] flex gap-[18px]">
                ...
                <Button
                  color="teal_900"
                  className="min-w-[89px] rounded-[17px] sm:px-5"
                >
                  Music
                </Button>
              </div>
          ...
          <div className="flex w-full justify-center gap-6 md:ml-0">
            <Button
              color="white_A700"
              size="xl"
              shape="round"
              className="min-w-[360px] !bg-white-A700 text-light_blue-700 border-[1px] border-light_blue-700 min-w-[246px] font-bold transition-transform duration-300 hover:scale-105 sm:px-5"
              onClick={() => goTo(`/screeningtestone/${jobId}`)}
            >
              Add Screening Test
            </Button>
            <Button
              size="xl"
              shape="round"
              className="min-w-[360px] font-bold sm:px-5"
            >
              Schedule Interview
            </Button>
          </div>
